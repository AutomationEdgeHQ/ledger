...
/**
 * Whether the forgot-password feature is available. Both system SMTP and
 * APP_URL must be set — the email needs a working link.
 */
export async function isPasswordResetAvailable() {
  if (!isSystemEmailConfigured()) return false;
