...
const SECRET_KEYS = new Set([
  ...
  'TEAMS_APP_PASSWORD',
  'TEAMS_TENANT_ID',
  // Email agent — per-firm OAuth app credentials. All stored as secrets so
  // updateApiKeySetting (which calls setConfigSecret) works consistently.
  // Client IDs / scopes aren't truly secret but it's simpler to keep them
  // in one bucket than split across secret/config stores.
